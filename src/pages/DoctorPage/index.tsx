      ...
      <div className={styles.content_wrapper}>
        <div className={styles.top_content}>
          <img
            ...
            src={`http://51.250.108.126:8080/api/files/${doctorData?.photoId}`}
          />
          <div className={styles.text_block}>
            <h1 className={styles.text_head}>
        ...
        <div className={styles.bottom_content}>
          <AppointmentsBlock time={time} doctorId={id}></AppointmentsBlock>
        </div>
      </div>
    </BaseLayout>
  );
